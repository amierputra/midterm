...
if (isset($_POST["submit"])) {
    ...
    $sqlregister = "INSERT INTO `tbl_admin`(`email`, `password`) VALUES('$email', '$pass')";
    try {
...
<html lang="ms">
    ...
    <body>
        ...
        <div class="w3-padding-64 w3-container" style="background-color: darkblue;">
            <div class="w3-card form-container">
                <form class="w3-container w3-amber w3-padding-24 w3-round-large formco" name="insertForm" action="register.php" method="post" onsubmit="return confirmDialog()" enctype="multipart/form-data">
                    <div class="w3-margin-left w3-margin-right">
                        ...
                        <div class="btn w3-center">
                            <button class="pointer w3-input w3-text-sand w3-border w3-block w3-round w3-hover-deep-orange" style="background-color: rgb(3, 3, 65);" name="submit">Register</button>
                        </div>
                    </div>  
            </form>
            </div
